    ...
    <div class="sidebar-wrapper active">
        <div class="sidebar-header position-relative">
            <div class="d-flex justify-content-between align-items-center">
                <div class="logo">
                    <a href="{{route('admin.home')}}"><img src="{{asset('admin/assets/compiled/svg/logo.svg')}}"
                                                           alt="Logo" srcset=""></a>
                </div>
                ...
                <li class="sidebar-item has-sub {{ request()->routeIs('admin.documents', 'admin.documenttypes') ? 'active' : '' }}">
                    ...
                    <ul class="submenu">
                        ...
                        <li class="submenu-item {{ request()->routeIs('admin.documents') ? 'active' : '' }}">
                            {{--                            hitung dokumen yang berstatus under_review--}}
                            @php
                                $count = App\Models\Document::where('status', 'under_review')->count();
                            @endphp
                            <a href="{{ route('admin.documents') }}" class="submenu-link d-flex justify-content-between">Dokumen @if($count > 0)
