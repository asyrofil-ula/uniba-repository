...
@section('title', 'Dokumen Fakultas ' . $faculty->name)

@section('content')
    <main class="container mx-auto px-4 py-10">
        <h1 class="text-2xl font-bold text-emerald-700 mb-6">Dokumen dari Fakultas {{ $faculty->name }}</h1>

        @if ($documents->isEmpty())
            <p class="text-gray-600">Belum ada dokumen dari fakultas ini.</p>
        @else
                            ...
                            <div class="flex items-start">
                                ...
                                <div class="flex-grow">
                                    ...
                                    <div class="mt-3 flex flex-wrap items-center text-sm text-gray-500">
                                        <span class="mr-4"><i class="fas fa-eye mr-1"></i> {{ $document->view_count }}
                                            dilihat</span>
                                        <span class="mr-4"><i class="fas fa-download mr-1"></i>
                                            {{ $document->download_count }} unduhan</span>
