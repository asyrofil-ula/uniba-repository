...
@section('title', 'Dokumen Tahun ' . $year)

@section('content')
    <main class="container mx-auto px-4 py-10">
        <h1 class="text-2xl font-bold text-emerald-700 mb-6">Dokumen Terbit Tahun {{ $year }}</h1>

        @if($documents->isEmpty())
            <p class="text-gray-600">Tidak ditemukan dokumen pada tahun ini.</p>
        @else
