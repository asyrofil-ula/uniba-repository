...
@section('title', 'Dokumen Oleh ' . $author->user->name)

@section('content')
    <main class="container mx-auto px-4 py-10">
        <h1 class="text-2xl font-bold text-emerald-700 mb-6">Dokumen oleh {{ $author->user->name }}</h1>

        @if($documents->isEmpty())
            <p class="text-gray-600">Penulis ini belum memiliki dokumen.</p>
        @else
